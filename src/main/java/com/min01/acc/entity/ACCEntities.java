...
public class ACCEntities
{
	...
	public static final RegistryObject<EntityType<EntityRadrifleBeam>> RADRIFLE_BEAM = registerEntity("radrifle_beam", createBuilder(EntityRadrifleBeam::new, MobCategory.MISC).fireImmune().sized(0.F, 0.5F).clientTrackingRange(100));
