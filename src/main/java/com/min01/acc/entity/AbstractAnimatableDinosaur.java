...
import com.min01.acc.entity.ai.control.AnimationBodyRotationControl;
import com.min01.acc.entity.ai.control.AnimationMoveControl;
import com.min01.acc.entity.ai.navigation.NoSpinGroundPathNavigation;
...
public abstract class AbstractAnimatableDinosaur extends DinosaurEntity implements IAnimatable
{
	public static final EntityDataAccessor<Integer> ANIMATION_STATE = SynchedEntityData.defineId(AbstractAnimatableDinosaur.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> ANIMATION_TICK = SynchedEntityData.defineId(AbstractAnimatableDinosaur.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> STOP_LOOK_TICK = SynchedEntityData.defineId(AbstractAnimatableDinosaur.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Integer> STOP_MOVE_TICK = SynchedEntityData.defineId(AbstractAnimatableDinosaur.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> IS_TARGET_VALID = SynchedEntityData.defineId(AbstractAnimatableDinosaur.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> IS_ANIMATION_PLAYING = SynchedEntityData.defineId(AbstractAnimatableDinosaur.class, EntityDataSerializers.BOOLEAN);

	public Vec3[] posArray;
	
	public AbstractAnimatableDinosaur(EntityType<? extends DinosaurEntity> pEntityType, Level pLevel)
	{
	...
	public void registerDefaultGoals()
	{
		...
		this.goalSelector.addGoal(0, new WaterAvoidingRandomStrollGoal(this, 1.0F, this.getMoveInterval())
		{
			...
			{
				return super.canUse() && AbstractAnimatableDinosaur.this.canMoveAround();
			}
			
			@Override
			protected Vec3 getPosition()
			{
				Vec2 radius = AbstractAnimatableDinosaur.this.getMoveRadius();
		...
		this.goalSelector.addGoal(0, new RandomLookAroundGoal(this)
		{
			...
			public boolean canUse()
			{
				return super.canUse() && AbstractAnimatableDinosaur.this.canLookAround();
			}
		});
