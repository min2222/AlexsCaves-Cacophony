...
public class FearEffect extends MobEffect
{
	...
	{
		List<PathfinderMob> list = p_19467_.level.getEntitiesOfClass(PathfinderMob.class, p_19467_.getBoundingBox().inflate(Math.min(5.0F * p_19468_, 20.0F)), t -> !t.isAlliedTo(p_19467_) && !(t instanceof TamableAnimal) || !((TamableAnimal) t).isInSittingPose());
		list.forEach(mob -> 
		{
