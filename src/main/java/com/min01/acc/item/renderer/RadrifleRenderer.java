...
public class RadrifleRenderer extends BlockEntityWithoutLevelRenderer
{
	...
	{
		p_108832_.pushPose();
		VertexConsumer vertexconsumer = p_108833_.getBuffer(RenderType.entityCutoutNoCull(getTexture(p_108830_)));
		...
		p_108832_.pushPose();
		VertexConsumer vertexconsumer2 = p_108833_.getBuffer(ACCRenderType.eyesFix(getLayerTexture(p_108830_)));
		p_108832_.scale(-1.0F, -1.0F, 1.0F);
		p_108832_.translate(0.0F, -1.5F, 0.0F);
		p_108832_.translate(-0.5F, -0.8F, 0.5F);
		this.model.setupAnim(p_108830_, 0, 0, ACCClientUtil.MC.player.tickCount + ACCClientUtil.MC.getFrameTime(), 0, 0);
	...
	public static ResourceLocation getLayerTexture(ItemStack stack)
	{
